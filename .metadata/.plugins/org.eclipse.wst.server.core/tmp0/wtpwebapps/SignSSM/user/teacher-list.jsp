...
<body>
	...
	<div class="wrapper">
		...
		<div class="page-content">
			<div class="content">
				...
				<form action="${pageContext.request.contextPath }/user/teacher" method="get">
	...
	<script type="text/javascript">
		//修改为学生
		function toStudent(obj,id){
			layui.use('layer',function(){
				var layer=layui.layer;
				layer.confirm("确定要修改为学生吗？",function(index){
					$.get('${pageContext.request.contextPath}/user/toStudent?id='+id,function(data){
						if(data.status == 0){
